...
get_count_cmd=`$TMUX_BIN show-environment -g __scroll_copy_mode__slow_scroll_count`
eval $get_count_cmd
...
$TMUX_BIN set-environment -g __scroll_copy_mode__slow_scroll_count $__scroll_copy_mode__slow_scroll_count
